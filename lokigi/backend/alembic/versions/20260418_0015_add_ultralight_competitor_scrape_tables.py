...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM(name="competitor_status_enum", create_type=False), nullable=False, server_default="active"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM(name="scrape_status_enum", create_type=False), nullable=False, server_default="running"),
    ...
    op.create_table(
        ...
        sa.Column("price_bucket", postgresql.ENUM(name="price_bucket_enum", create_type=False), nullable=False, server_default="unknown"),
        ...
        sa.Column("source_status", postgresql.ENUM(name="scrape_status_enum", create_type=False), nullable=False, server_default="ok"),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("NOW()")),
