...
├── supabase/          # Esquemas y funciones de Supabase
├── .gitignore
└── README.md
```
...
## Notas
- No instales dependencias Node.js en la raíz, solo en frontend/.
- No instales dependencias Python fuera de backend/.
- Los entornos virtuales y node_modules están ignorados por git.
- Haz commits separados para cambios en backend y frontend.
